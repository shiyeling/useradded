...
""""
"
"Yeling's Vim config file
"
"Most parts of this config file is borrowed from
"Amix's vimrc http://amix.dk/
"
"
"
"
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Colors and Fonts
" Since the following sections really needs MySys()
...
map <leader>1 :set syntax=javascript<cr>
map <leader>2 :set syntax=xhtml<cr>
map <leader>3 :set syntax=python<cr>
map <leader>4 :call FormatAsXml()<cr>
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Fileformats "
" not so sure about what is this section for
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"Favorite filetypes
...
set ruler
"Keep the commandline height as 1 @shiyeling
set cmdheight=1
...
"Highlight search words, Incremental search
set hlsearch
set incsearch
"Set magic on
set magic
...
set laststatus=2
function! CurDir()
  let curdir = substitute(getcwd(), '\_.*g706811/', "~/", "g")
  return curdir
endfunction
"Format the statusline
set statusline=%<\ %F%m%r%h\ %(%w\ %)CWD:%r%{CurDir()}%h%=[%{(&fenc==\"\")?&enc:&fenc}],%-10.(%l/%L:%c%V%)


""""""""""""""""""""""""""""""
" Visual
" no idea about this section either @yeling
""""""""""""""""""""""""""""""
...
" map <right> :bn<cr>
" map <left> :bp<cr>
" but I would like to use the arrow keys to move around tabs @yeling TODO
"Tab configuration
...
" what does this mean? @yeling TODO
imap <m-$> <esc>$a
imap <m-0> <esc>0i
imap <D-$> <esc>$a
imap <D-0> <esc>0i
...
"no idea either @yeling
"guess this is not so important
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Buffer realted
" really no idea about this section TODO
" maybe later @Yeling Shi
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
au BufReadPost * if line("'\"") > 0|if line("'\"") <= line("$")|exe("norm '\"")|else|exe "norm $"|endif|endif
  ...
  "Auto indent
  set ai
  "Smart indet. Yeling when cindent is on smartindent has no effect
  set si
  "C-style indeting
  set cindent
  "Wrap lines
  ...
  " Tag list (ctags) 
  """"""""""""""""""""""""""""""
"   let Tlist_Ctags_Cmd = "C:/Users/I076721/dev/Tools/ctags58/ctags.exe"
...
set tags=C:/Users/yshi/vimfiles/doc/tags
  
  """"""""""""""""""""""""""""""
  " TagBar using ctags 
  """"""""""""""""""""""""""""""
  "map <leader>tt :TagbarToggle<cr>
  "let g:tagbar_ctags_bin = "C:/Users/I076721/dev/Tools/ctags58/ctags.exe"

  """"""""""""""""""""""""""""""
  " PATH for jsctags
  """"""""""""""""""""""""""""""
  "let $PATH = 'C:\Users\I076721\dev\Tools\jsctags' . $PATH

  """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  " Configure the window layout
  """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  let g:winManagerWindowLayout='FileExplorer'
  nmap <leader>tw :WMToggle<cr>

  """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  " Indexer config 
  """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  let g:indexer_indexerListFilename='C:/Users/I076721/vimfiles/usercfg/projects.vim'
  ...
  """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  " Filetype generic
  " Totally lost, just use the original config to see if it works
  " @Yeling Shi TODO
  """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  " Todo
  ...
  " au FileType python so ~/vim_local/syntax/python.vim @Yeling Shi seems I don't need this
  autocmd FileType python map <buffer> <leader><space> :w!<cr>:!python %<cr>
  " autocmd FileType python so ~/vim_local/plugin/python_fold.vim @Yeling Shi seems I don't need this
  ...
  "Java comments
  " autocmd FileType java source ~/vim_local/macros/jcommenter.vim @Yeling Shi seems I don't need this
